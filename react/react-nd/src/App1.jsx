...
//4. Sukurti keturis komponentus Vandenynas, Tipas, Vardas, Spalva. Vandenynas tėvinis 
...
//5. Sukurti penkis komponentus. Pasaulis, Namas, Narvas, Garazas ir Akvariumas. Pasaulis
// tėvinis komponentas, kiti keturi vaikiniai. Atvaizduoti masyvą seaPlaners pagal taisyklę:
// “man” - Namas, “car” - Garazas, “animal” - Narvas, “fish” - Akvariumas. Komponentas Pasaulis
// turi būti padalintas į dvi dalis- porinę ir neporinę (pagal id, ne masyvo indeksą). 
//Visus keturis vaikinius komponentus panaudoti po du kartus - porinėje ir neporinėje dalyje, 
//atvaizduojant porinius ir neporinius masyvo įrašus.
...
function App() {
  return (
    ...
    <Tvenkinys sea={seaPlaners.filter(seaPlaners => seaPlaners.id % 2 === 0 )}></Tvenkinys>
    <Tvenkinys sea={seaPlaners.filter(seaPlaners => seaPlaners.id % 2 !== 0 )}></Tvenkinys>
